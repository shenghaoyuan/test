    ...
    default:
      {
        ...
        return Fletcher32_dowhile(t, tlen - (uint32_t)1U, d, sum1, sum2);
      }
  }
}
    ...
    default:
      {
        ...
        K___uint32_t_uint32_t scrut = Fletcher32_dowhile(tlen_32, tlen_32, data, s1, s2);
        uint32_t sum1 = scrut.fst;
        uint32_t sum2 = scrut.snd;
        return
          Fletcher32_while_t(words - tlen,
            data,
...
{
  K___uint32_t_uint32_t
  scrut = Fletcher32_while_t(words, data, (uint32_t)0xffffU, (uint32_t)0xffffU);
